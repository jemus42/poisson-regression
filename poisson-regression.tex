...
\setlength{\droptitle}{-2em}
  ...
  \postdate{\par}
    \date{Stand: 18. September 2019 15:31 Uhr (CEST)}
...
\begin{quote}
\textbf{persons}: If a group were to increase its persons value by one, the odds that it would be in the \enquote{Certain Zero} group would decrease by a factor of exp(-0.5643) = 0.5687581. In other words, the more people in a group, the less likely the group is a certain zero.
\end{quote}
