...
Zur Evaluation des Despersionparameters kann ein NBH Modell (\@ref(mod-nbh)) genutzt werden, wobei der  Dispersionsparameter modelliert wird (-> welche Variablen tragen zur extradispersion bei).
