...
# Zweiparametrische Modelle {#zweiparam}

Zweiparametrische Modelle haben neben dem Parameter für den Erwartungswert einen weiteren Parameter für die Varianz – was wir natürlich insbesondere im Kontext der Dispersionsproblematik sehr nützlich finden.

Ein Überblick einiger zweiparametrischer Modelle mit parametrisierter Varianz (nach @hilbeModelingCountData2014, p. 12).
