...
Folgende Tabellegibt eine Übersicht über Modelle, die zur Modellierung von Daten unter unterschiedlichen Dispersionsannahmen geeignet sind
...
tibble::tribble(
  ...
  kable(booktabs = TRUE, escape = FALSE, 
        caption = "Überblick einiger Modelle mit Parametrisierter Varianz (nach @hilbeModelingCountData2014, p. 12)") %>%
