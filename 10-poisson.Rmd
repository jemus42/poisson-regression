...
Die Pearson $\chi^2$-Statistik ist die Summe der quadriertern (Pearson-)Residuen gewichtet mit der Modellvarianz:
...
Daraus lässt sich auch schließen, dass in Situationen mit binären outcomes und sehr niedrigem Erwartungswert die erwartete Anzahl an Nullen sehr hoch sein wird – weshalb es an dieser Stelle vermutlich eine großer Überlappung zwischen underdispersion und zero-inflation gibt.
